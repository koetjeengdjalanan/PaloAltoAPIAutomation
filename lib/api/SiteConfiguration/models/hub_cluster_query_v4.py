...
class HubClusterQueryV4(BaseModel):
    """
    HubClusterQueryV4
    """ # noqa: E501
    aggregate: Optional[Aggregate] = None
    dest_page: Optional[StrictInt] = Field(default=None, description="The destination page. ")
    get_deleted: Optional[StrictBool] = Field(default=None, description="The number of hub clusters deleted for a time frame. ", alias="getDeleted")
    group_by: Optional[List[StrictStr]] = Field(default=None, description="Group the hub clusters for the query. ")
    id: Optional[StrictStr] = Field(default=None, description="List the hub clusters by ID.     ")
    ...
    next_query: Optional[Dict[str, Any]] = Field(default=None, description="List the  next query. ")
    ...
    retrieved_fields_mask: Optional[StrictBool] = Field(default=None, description="List the marked fields to query. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HubClusterQueryV4 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HubClusterQueryV4 from a dict"""
        if obj is None:
            return None
