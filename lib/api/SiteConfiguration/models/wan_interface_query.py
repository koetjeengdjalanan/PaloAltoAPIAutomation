...
class WANInterfaceQuery(BaseModel):
    """
    WANInterfaceQuery
    """ # noqa: E501
    aggregate: Optional[Aggregate] = None
    dest_page: Optional[StrictInt] = Field(default=None, description="The destination page. ")
    get_deleted: Optional[StrictBool] = Field(default=None, description="The number app definitions deleted for a time frame. ", alias="getDeleted")
    group_by: Optional[List[StrictStr]] = Field(default=None, description="Group By")
    id: Optional[StrictStr] = Field(default=None, description="List the app definitions by ID.     ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WANInterfaceQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WANInterfaceQuery from a dict"""
        if obj is None:
            return None
