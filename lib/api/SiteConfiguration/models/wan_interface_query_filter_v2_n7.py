...
class WANInterfaceQueryFilterV2N7(BaseModel):
    """
    ...
    bwc_enabled: Optional[StrictBool] = Field(default=None, description="The bwc parameters. ")
    ...
    description: Optional[Any] = Field(default=None, description="The description of the WAN interface config. ")
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the WAN interface config. ")
    network_id: StrictStr = Field(description="The network ID. ")
    site_id: StrictStr = Field(description="Site Id: Digits(fraction = 0, integer = 50, SITEID_INVALID) NotNull ")
    tags: Optional[List[StrictStr]] = Field(default=None, description="An information field that can be added to identify the WAN interface. Maximum 10 unique tags of length 1024 each are allowed.       ")
    type: Optional[StrictStr] = Field(default=None, description="WAN type. ")
    use_for_application_reachability_probes: Optional[StrictBool] = Field(default=None, description="Indicates if the use for application reachability probe is selected. True or False. ")
    use_for_controller_connections: Optional[StrictBool] = Field(default=None, description="Indicates if the use for controller connections is selected. True or False. ")
    use_lqm_for_non_hub_paths: Optional[StrictBool] = Field(default=None, description="Use Lqm For Non Hub Paths")
    vpnlink_configuration: Optional[VPNLinkConfiguration] = None
    __properties: ClassVar[List[str]] = ["bfd_mode", "bw_config_mode", "bwc_enabled", "cost", "description", "id", "label_id", "link_bw_down", "link_bw_up", "lqm_config", "lqm_enabled", "name", "network_id", "site_id", "tags", "type", "use_for_application_reachability_probes", "use_for_controller_connections", "use_lqm_for_non_hub_paths", "vpnlink_configuration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WANInterfaceQueryFilterV2N7 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WANInterfaceQueryFilterV2N7 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "use_lqm_for_non_hub_paths": obj.get("use_lqm_for_non_hub_paths"),
