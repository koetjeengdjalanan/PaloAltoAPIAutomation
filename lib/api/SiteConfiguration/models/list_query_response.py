...
class ListQueryResponse(BaseModel):
    ...
    description: Optional[Any] = Field(default=None, description="Description of the query. Max size = 256. ")
    ...
    __properties: ClassVar[List[str]] = ["count", "deleted_count", "deleted_ids", "description", "id", "next_query", "total_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListQueryResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListQueryResponse from a dict"""
        if obj is None:
            return None
