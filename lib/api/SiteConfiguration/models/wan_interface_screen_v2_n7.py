...
class WANInterfaceScreenV2N7(BaseModel):
    """
    WANInterfaceScreenV2N7
    """ # noqa: E501
    ...
    use_lqm_for_non_hub_paths: Optional[StrictBool] = Field(default=None, description="Indicates if the use for lqm for non hub paths is enabled. ")
    vpnlink_configuration: Optional[VPNLinkConfiguration] = None
    __properties: ClassVar[List[str]] = ["bfd_mode", "bw_config_mode", "bwc_enabled", "cost", "description", "id", "label_id", "link_bw_down", "link_bw_up", "lqm_config", "lqm_enabled", "name", "network_id", "tags", "type", "use_for_application_reachability_probes", "use_for_controller_connections", "use_lqm_for_non_hub_paths", "vpnlink_configuration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WANInterfaceScreenV2N7 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WANInterfaceScreenV2N7 from a dict"""
        if obj is None:
            return None
