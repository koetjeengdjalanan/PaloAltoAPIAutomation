...
class SiteQuery(BaseModel):
    ...
    get_deleted: Optional[StrictBool] = Field(default=None, description="The number sites deleted for a time frame. ", alias="getDeleted")
    group_by: Optional[List[StrictStr]] = Field(default=None, description="Group By")
    id: Optional[StrictStr] = Field(default=None, description="List the sites by ID.     ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SiteQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SiteQuery from a dict"""
        if obj is None:
            return None
