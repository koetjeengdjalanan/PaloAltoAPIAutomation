...
class GetSdwanV30ApiSitesSiteIdHubclustersHubClusterIdHubclustermembers200Response(BaseModel):
    """
    ...
    items: Optional[List[HubClusterMemberScreen]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSdwanV30ApiSitesSiteIdHubclustersHubClusterIdHubclustermembers200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSdwanV30ApiSitesSiteIdHubclustersHubClusterIdHubclustermembers200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [HubClusterMemberScreen.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
