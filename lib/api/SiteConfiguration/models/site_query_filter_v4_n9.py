...
class SiteQueryFilterV4N9(BaseModel):
    """
    SiteQueryFilterV4N9
    """ # noqa: E501
    ...
    perfmgmt_policysetstack_id: Optional[StrictStr] = Field(default=None, description="ID for the Performance Policyset Stack.  ")
    ...
    security_policyset_id: Optional[StrictStr] = Field(default=None, description="The ID for the Original Security Policy Set. Can be retrieved using securitypolicysets API. ")
    ...
    __properties: ClassVar[List[str]] = ["address", "admin_state", "description", "element_cluster_role", "extended_tags", "id", "location", "multicast_peer_group_id", "name", "nat_policysetstack_id", "network_policysetstack_id", "perfmgmt_policysetstack_id", "policy_set_id", "priority_policysetstack_id", "security_policyset_id", "security_policysetstack_id", "service_binding", "tags", "vrf_context_profile_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SiteQueryFilterV4N9 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SiteQueryFilterV4N9 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "perfmgmt_policysetstack_id": obj.get("perfmgmt_policysetstack_id"),
