...
class PostSdwanV48ApiSitesQuery200Response(BaseModel):
    """
    ...
    items: Optional[List[SiteQueryFilterV4N8]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostSdwanV48ApiSitesQuery200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostSdwanV48ApiSitesQuery200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [SiteQueryFilterV4N8.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
