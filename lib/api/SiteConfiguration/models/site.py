...
class Site(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address", "admin_state", "description", "element_cluster_role", "id", "location", "name", "policy_set_id", "security_policyset_id", "service_binding"]
